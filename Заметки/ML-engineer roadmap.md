...
- [ ] Определители
	...
	- [ ] Методы нахождения определителей (определитель 1-го порядка, определитель 3-го порядка, правило треугольника, разложение по строке/столбцу, метод Гаусса, Теорема Лапласа)
...
## 2.2 Интегральное исчисление функции одной переменной
# 3. Теорвер
# 4. Матстат
# 5. Дискра
# 6. Прога
