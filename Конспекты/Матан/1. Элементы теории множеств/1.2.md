>Функции (отображения). Образ и прообраз. Простейшая классификация отображений. График отображения. Обратное отображение. Композиция функций и обратные отображения
# Понятие отображения
